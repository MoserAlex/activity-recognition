...
def setup(training_subjects: int, test_subject: int, activities: Activities, features: Features, sensor_position: SensorPosition):
  __setup_subjects(training_subjects, test_subject)
  __setup_sensor(sensor_position)
  __setup_activities(activities)
  __setup_features(features)
  # global g_report_text
  # g_report_text += 'The machine is trained with the data of {} training subject'.format(training_subjects)
...
def __setup_features(features: Features):
  global g_report_text
